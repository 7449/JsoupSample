...
public class CiLiLianJsoupManager {
    private Document document;

    private CiLiLianJsoupManager(Document document) {
        this.document = document;
    }

    public static CiLiLianJsoupManager get(@NonNull Document document) {
        return new CiLiLianJsoupManager(document);
    }
