...
public class JsoupBiQuGeHomeManager {
    ...
    public List<BiQuGeHomeContentsModel> getBiQugeContents() {
        List<BiQuGeHomeContentsModel> list = new ArrayList<>();
        BiQuGeHomeContentsModel contentsModel;
        Elements a = document.select("#list").select("a");
        for (Element element : a) {
            contentsModel = new BiQuGeHomeContentsModel();
    ...
    public BiQuGeHomeDetailModel getBiQuGeHomeDetail() {
        BiQuGeHomeDetailModel detailModel = new BiQuGeHomeDetailModel();
