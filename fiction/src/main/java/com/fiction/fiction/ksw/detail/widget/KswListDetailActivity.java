...
import com.fiction.fiction.ksw.detail.presenter.KswListDetailPresenter;
import com.fiction.fiction.ksw.detail.presenter.KswListDetailPresenterImpl;
...
public class KswListDetailActivity extends BaseActivity
        implements KswListDetailView, View.OnClickListener, EasyWebView.WebViewLoadListener {
    private static final String URL = "url";

    private Toolbar toolbar;
    private ContentLoadingProgressBar progressBar;
    private KswListDetailPresenter presenter;
    ...
    public static void getInstance(String url) {
        ...
        UIUtils.startActivity(KswListDetailActivity.class, bundle);
    }

    @Override
    protected void initCreate(Bundle savedInstanceState) {
        webView.setLoadListener(this);
        presenter = new KswListDetailPresenterImpl(this);
    ...
    protected int getLayoutId() {
        return R.layout.activity_ksw_list_detail;
    }

    @Override
    public void netWorkSuccess(KswListDetailModel data) {
        onUrl = data.onPage;
