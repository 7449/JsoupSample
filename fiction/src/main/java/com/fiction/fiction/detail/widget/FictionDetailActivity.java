package com.fiction.fiction.detail.widget;
...
import com.fiction.fiction.detail.presenter.FictionDetailPresenter;
import com.fiction.fiction.detail.presenter.FictionDetailPresenterImpl;
...
public class FictionDetailActivity extends BaseActivity
        implements FictionDetailView, View.OnClickListener, EasyWebView.WebViewLoadListener {
    ...
    private FictionDetailPresenter presenter;
