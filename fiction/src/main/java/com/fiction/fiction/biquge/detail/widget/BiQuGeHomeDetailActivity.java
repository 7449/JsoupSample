package com.fiction.fiction.biquge.detail.widget;
...
import com.fiction.fiction.biquge.detail.presenter.BiQuGeHomeDetailPresenter;
import com.fiction.fiction.biquge.detail.presenter.BiQuGeHomeDetailPresenterImpl;
...
public class BiQuGeHomeDetailActivity extends BaseActivity
        implements BiQuGeHomeDetailView, OnClickListener, EasyWebView.WebViewLoadListener {
    private static final String URL = "url";

    private Toolbar toolbar;
    private ContentLoadingProgressBar progressBar;
    private BiQuGeHomeDetailPresenter presenter;
    ...
    public static void getInstance(String url) {
        ...
        UIUtils.startActivity(BiQuGeHomeDetailActivity.class, bundle);
    }

    @Override
    protected void initCreate(Bundle savedInstanceState) {
        webView.setLoadListener(this);
        presenter = new BiQuGeHomeDetailPresenterImpl(this);
    ...
    protected int getLayoutId() {
        return R.layout.activity_biquge_home_detail;
    }

    @Override
    public void netWorkSuccess(BiQuGeHomeDetailModel data) {
        onUrl = data.onPage;
