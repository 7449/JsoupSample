...
import com.fiction.fiction.biquge.detail.presenter.BiQuGeListDetailPresenter;
import com.fiction.fiction.biquge.detail.presenter.BiQuGeListDetailPresenterImpl;
...
public class BiQuGeListDetailActivity extends BaseActivity
        implements BiQuGeListDetailView, View.OnClickListener, EasyWebView.WebViewLoadListener {
    private static final String URL = "url";

    private Toolbar toolbar;
    private ContentLoadingProgressBar progressBar;
    private BiQuGeListDetailPresenter presenter;
    ...
    public static void getInstance(String url) {
        ...
        UIUtils.startActivity(BiQuGeListDetailActivity.class, bundle);
    }

    @Override
    protected void initCreate(Bundle savedInstanceState) {
        webView.setLoadListener(this);
        presenter = new BiQuGeListDetailPresenterImpl(this);
    ...
    @Override
    public void netWorkSuccess(BiQuGeListDetailModel data) {
        onUrl = data.onPage;
