...
public class FictionHomeAdapter extends RecyclerView.Adapter<SuperViewHolder> {
    private List<FictionModel> list = null;
    private String type = ApiConfig.Type.ZW_81;

    public FictionHomeAdapter(List<FictionModel> list, String type) {
        this.list = list;
        this.type = type;
    }
    ...
    public void onBindViewHolder(SuperViewHolder holder, int position) {
        ...
        FictionModel kswHomeModel = list.get(position);
